...
<div class="card">
    ...
    <div class="card-body">
        <form method="GET" action="<?= base_url('reports/trial-balance') ?>" class="mb-4">
            <div class="row">
                <div class="col-md-6">
...
$(document).ready(function() {
    ...
    $('#exportPdf').attr('href', '<?= base_url('reports/trial-balance-pdf') ?>?' + params.toString());
    $('#exportExcel').attr('href', '<?= base_url('reports/trial-balance-excel') ?>?' + params.toString());
});
</script>
<?= $this->endSection() ?>
