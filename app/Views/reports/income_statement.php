...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-chart-line"></i> <?= $title ?></h3>
    </div>
    <div class="card-body">
        <form method="GET" action="<?= base_url('reports/income-statement') ?>" class="mb-4">
            <div class="row">
                <div class="col-md-5">
...
$(document).ready(function() {
    ...
    $('#exportPdf').attr('href', '<?= base_url('reports/income-statement-pdf') ?>?' + params.toString());
    $('#exportExcel').attr('href', '<?= base_url('reports/income-statement-excel') ?>?' + params.toString());
});
</script>
<?= $this->endSection() ?>
