...
class GoodsReceiptController extends BaseController
{
    ...
    {
        $this->model = new GoodsReceiptModel();
        helper(['form', 'url']);
    }
    ...
    public function index()
    {
        ...
        return view('purchase/goodsreceipt/index', $data);
    }
        ...
        foreach ($records as $record) {
            $data[] = [
                ...
                'actions' => '<div class="btn-group">
                    <a href="' . base_url('purchase/goodsreceipt/edit/' . $record['id']) . '" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
    ...
    public function create()
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ['label' => 'Purchase', 'url' => '#'],
                ['label' => 'Goods Receipts', 'url' => base_url('purchase/goodsreceipt')],
                ['label' => 'Create']
            ]
        ];

        return view('purchase/goodsreceipt/create', $data);
    }
    ...
    public function store()
    {
        ...
        if ($this->model->insert($data)) {
            ...
            return redirect()->to('/purchase/goodsreceipt')->with('success', 'Record created successfully');
        }
    ...
    public function edit($id)
    {
        ...
        if (!$record) {
            return redirect()->to('/purchase/goodsreceipt')->with('error', 'Record not found');
        }

        $data = [
            'title' => 'Edit Goods Receipts',
            'breadcrumbs' => [
                ['label' => 'Purchase', 'url' => '#'],
                ['label' => 'Goods Receipts', 'url' => base_url('purchase/goodsreceipt')],
                ['label' => 'Edit']
        ...
        return view('purchase/goodsreceipt/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        if ($this->model->update($id, $data)) {
            ...
            return redirect()->to('/purchase/goodsreceipt')->with('success', 'Record updated successfully');
        }
