...
class SalesOrderController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('sales/salesorder/index', $data);
    }
        ...
        foreach ($records as $record) {
            $data[] = [
                ...
                'actions' => '<div class="btn-group">
                    <a href="' . base_url('sales/salesorder/edit/' . $record['id']) . '" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
    ...
    public function create()
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ['label' => 'Sales', 'url' => '#'],
                ['label' => 'Sales Orders', 'url' => base_url('sales/salesorder')],
                ['label' => 'Create']
            ]
        ];

        return view('sales/salesorder/create', $data);
    }
    ...
    public function store()
    {
        ...
        if ($this->model->insert($data)) {
            ...
            return redirect()->to('/sales/salesorder')->with('success', 'Record created successfully');
        }
    ...
    public function edit($id)
    {
        ...
        if (!$record) {
            return redirect()->to('/sales/salesorder')->with('error', 'Record not found');
        }
        ...
        return view('sales/salesorder/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        if ($this->model->update($id, $data)) {
            ...
            return redirect()->to('/sales/salesorder')->with('success', 'Record updated successfully');
        }
