...
class DeliveryOrderController extends BaseController
{
    ...
    {
        $this->model = new DeliveryOrderModel();
        helper(['form', 'url']);
    }
    ...
    public function index()
    {
        ...
        return view('sales/deliveryorder/index', $data);
    }
        ...
        foreach ($records as $record) {
            $data[] = [
                ...
                'actions' => '<div class="btn-group">
                    <a href="' . base_url('sales/deliveryorder/edit/' . $record['id']) . '" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
    ...
    public function create()
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ['label' => 'Sales', 'url' => '#'],
                ['label' => 'Delivery Orders', 'url' => base_url('sales/deliveryorder')],
                ['label' => 'Create']
            ]
        ];

        return view('sales/deliveryorder/create', $data);
    }
    ...
    public function store()
    {
        ...
        if ($this->model->insert($data)) {
            ...
            return redirect()->to('/sales/deliveryorder')->with('success', 'Record created successfully');
        }
    ...
    public function edit($id)
    {
        ...
        if (!$record) {
            return redirect()->to('/sales/deliveryorder')->with('error', 'Record not found');
        }

        $data = [
            'title' => 'Edit Delivery Orders',
            'breadcrumbs' => [
                ['label' => 'Sales', 'url' => '#'],
                ['label' => 'Delivery Orders', 'url' => base_url('sales/deliveryorder')],
                ['label' => 'Edit']
        ...
        return view('sales/deliveryorder/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        if ($this->model->update($id, $data)) {
            ...
            return redirect()->to('/sales/deliveryorder')->with('success', 'Record updated successfully');
        }
